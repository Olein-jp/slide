...
- 自分でできることとできないことを理解する
- できないことは**専門家に依頼**する
- できることは**自分でやる**ことでスキルアップにも繋がる
  - **学習コスト**と**外部委託費用**などのバランス
---

## アップデートへの認識を正しく

- システムは最適な状態を維持するべき
- 最適な状態を保つ努力をしないのにセキュリティ云々言わない
- 自動アップデートを適切に活用しよう

---

## WordPress の変化にアンテナを貼ると良い

- WordPress は進化し続けている
- その変化を知っておくことで見えてくるものもある
  - 自分の使っているテーマやプラグインがどこまで対応しているか
  - WordPress の機能をどれくらい活用できているか

---

## 利用プロダクトの変化も確認を

- 利用するテーマやプラグインの動向を意識する
- WordPress の変化にどのように対応しているか
- それを知ることで、今後利用するべきかどうかも判断できる
...
- WordPress は（適切に情報を収集して管理すれば）とても楽しいです
- 楽しむための準備をしておくことが大切
- 何かわからないことがあれば、**コミュニティイベント**で相談してみよう
- **進化し続けているものを知るには、学び続けるしかない**
- Gifu WordPress Meetup も活用してください